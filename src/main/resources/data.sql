...
INSERT INTO TRENING(NAZIV, OPIS, TIP, TRAJANJE, TRENER_ID) values ('kros', 'Snaga','GLADIATOR', 1, 4);
INSERT INTO TRENING(NAZIV, OPIS, TIP, TRAJANJE, TRENER_ID) values ('gym', 'Kondicija', 'CROSSFIT', 1,4);
