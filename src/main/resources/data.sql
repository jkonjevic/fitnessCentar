...
INSERT INTO FITNES_CENTAR (ADRESA, BR_CENTRALE, EMAIL, NAZIV) values ('Bulevar Cara Lazara 13', '0691499392', 'fitnescentar2@gmail.com', 'DejoBidza');
...
INSERT INTO KORISNIK(AKTIVAN, DATUM, EMAIL, IME, KONTAKT, KORISNICKO_IME, LOZINKA, ULOGA,FITNES_CENTAR_ID, PREZIME) values (true, '2011-11-02 19:00:00.000000', 'joco@gmail.com', 'Jovan', '06312521512', 'CogunBratenga', '123','ADMINISTRATOR',1,'konjevic');
...
INSERT INTO TERMIN(CIJENA, POCETAK, SALA_ID, TRENING_ID, BR_PRIJAVLJENIH) values (12, '2020-01-01 16:00:00.000000', 2,2,5);
...
INSERT INTO TERMIN(CIJENA, POCETAK, SALA_ID, TRENING_ID, BR_PRIJAVLJENIH) values (10, '2020-04-04 15:00:00.000000', 1,1,20);
...
INSERT INTO PRIJAVLJENI(KORISNIK_ID, TERMIN_ID) values (3,1);
INSERT INTO PRIJAVLJENI(KORISNIK_ID, TERMIN_ID) values (3,4);